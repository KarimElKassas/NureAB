          ...
          return Container(
            child: Column(
              children: [
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (value) {
                            ...
                            print(
                                'length before ${PatientListCubit.get(context).patientList.length}');
                ...
                cubit.filteredPatientList != null
                    ? BuildCondition(
                        ...
                        fallback: (context) => ListView.builder(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              AutoSizeText(
                                                cubit.filteredPatientList[index]
                                                    .name,
                                                style: TextStyle(
                          ...
                          itemCount: cubit.filteredPatientList.length,
                        ),
                      )
                    : Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'You need to create at least one patient So you can start treating him / her with the device.',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: ScreenUtil()
                                      .setSp(14, allowFontScalingSelf: true),
