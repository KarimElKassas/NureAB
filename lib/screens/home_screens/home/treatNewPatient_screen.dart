                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding:
                                      EdgeInsets.only(top: 8.h, left: 26.w),
                                  child: RichText(
                                    text: TextSpan(
                                      style: TextStyle(
                                ...
                                Padding(
                                  padding:
                                      EdgeInsets.only(top: 20.h, left: 26.w),
                                  child: RichText(
                                    text: TextSpan(
                                      style: TextStyle(
                                        fontSize: ScreenUtil().setSp(18,
                                    ...
                                    function: () {
                                      if (!formKey.currentState.validate()) {
                                        ...
                                        const snackBar = SnackBar(
                                          ...
                                          content: Text(
                                              'you have to choose the patient case'),
                                        );
                                      ...
                                      print(
                                          'patient case ${cubit.idOptionItemSelected.title}');
